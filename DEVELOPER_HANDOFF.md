...
> **Latest Update:** ✅ Automation settings UI tightened: PM auto-generation now uses one clear Off/Manual/Scheduled selector, hides PM schedule controls unless Scheduled is selected, and keeps persisted `pm_auto_generation_enabled/mode` settings mapped through a tested helper.
