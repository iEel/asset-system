...
> **Latest Update:** ✅ Split Asset Detail formatting helpers. Warranty state, license-key masking, photo-checklist matching, movement-detail compaction, and tone classes now live in `src/lib/asset-detail-format.ts` with regression tests, reducing the large asset detail page without behavior changes.
