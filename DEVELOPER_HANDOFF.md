...
> **Latest Update:** ✅ System Settings information architecture improved: retention/governance settings now have a dedicated tab with editable retention days, Storage Governance shortcut, overview status, validation, and regression/browser checks.
