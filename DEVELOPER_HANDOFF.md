...
> **Latest Update:** ✅ Added guarded `npm run cleanup:test-data` workflow with dry-run/apply safety gates, hard-deleted current trial assets (`QA-COM-05-0001`, `Sonic-COM-05-0001`) and related attachments/checkouts/checkins/movements, and verified remaining assets = 0 so run numbers recalculate from clean data.
