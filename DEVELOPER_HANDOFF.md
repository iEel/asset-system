...
> **Latest Update:** ✅ PWA manifest shortcuts added: installed app users can long-press/right-click the app icon to jump to scan/search, add asset, Work Center, and audit rounds.
