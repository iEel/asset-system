...
| `src/lib/production-readiness.ts` | Go-live readiness checks and summary helper for QR, workflow approval, notifications, admins, and master data |
...
| **Production Readiness** | เพิ่มหน้า `/admin/readiness` ใต้เมนู Administration เพื่อตรวจความพร้อมใช้งานจริงจากข้อมูลจริง: Public QR Base URL ต้องเป็น domain เสถียร, workflow approver coverage ต้องไม่ขาด, notification rules ต้องเป็นค่า 0-365, ควรมี system_admin อย่างน้อย 2 บัญชี, และ master data ขั้นต่ำต้องมีครบ |
...
141. Production Readiness checklist with `/admin/readiness`, sidebar navigation, QR/workflow/notification/admin/master-data checks, and helper regression tests
