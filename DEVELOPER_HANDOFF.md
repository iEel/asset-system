...
> **Latest Update:** ✅ LDAP Sync offboarding guard added: preview/apply now reports employees missing from AD who still hold active assets or linked active app users, Apply deactivates linked app user accounts when deactivate-missing is enabled, and System Settings shows impact links back to filtered Asset Register cleanup.
...
167. LDAP offboarding guard with missing-from-AD deactivation impact summaries, active asset/user counts, Asset Register cleanup links, linked app user deactivation during apply, and helper regression tests
