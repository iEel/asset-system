...
> **Latest Update:** ✅ Legacy Asset Import column mapping added. Import preview now detects Thai/legacy headers such as asset code, description, and serial fields, shows a mapping summary in the wizard, and falls back to the original template order when a file has no recognizable header row.
