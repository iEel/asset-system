...
> **Latest Update:** ✅ PWA safe shell cache added: production registers `public/sw.js`, caches only manifest/icons/offline fallback, bypasses API/Next/uploads/private data, and shows `public/offline.html` for navigation failures.
