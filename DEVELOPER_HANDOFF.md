...
> **Latest Update:** ✅ PWA identity pass added: generated Asset Tag + QR + Check artwork is now used for favicon, app icon, Apple touch icon, PWA manifest icons, maskable icons, and theme metadata.
