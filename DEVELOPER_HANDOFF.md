...
104. Data Quality Rule Center with configurable asset-register quality checks stored in system settings, an admin page showing issue counts per rule, and exact Asset Register drilldowns for responsibility, serial, photo, department, purchase, and warranty gaps
