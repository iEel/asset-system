...
> **Latest Update:** ✅ Added Supplier Profile Detail. Supplier rows now drill down to `/master-data/suppliers/[id]`, showing contact profile, linked assets, centralized purchase documents, vendor repair history, cost summaries, and follow-up flags with helper regression tests.
