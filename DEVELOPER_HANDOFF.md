...
> **Latest Update:** ✅ Audit offline queue UX strengthened: scan page now shows online/offline state, queued photo count, failed sync count, latest sync error, and disables retry while the device is offline.
