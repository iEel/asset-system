...
> **Latest Update:** ✅ Standard verification scripts added. `npm test` now runs every test file under `tests/`, and `npm run verify` runs lint, all tests, and production build so future handoff commits can use one repeatable release check.
