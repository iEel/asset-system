...
| **Drag/drop uploads** | เพิ่ม `src/components/ui/file-dropzone.tsx` และใช้งานใน Asset photos/files, Asset Model photos, และ Maintenance attachments; ยังรองรับ click-to-select, เลือกไฟล์เดิมซ้ำได้หลัง retry, และ validation รองรับรูป `jpeg/png/webp/gif/avif/heic/heif` |
