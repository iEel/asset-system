...
- Asset ownership schema pushed; `assets.ownershipType` exists with default `personal` and supports `personal`, `shared`, `stock`, `component`, and `software_license`
