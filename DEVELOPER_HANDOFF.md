...
> **Latest Update:** ✅ Configurable depreciation/accounting policy added. System Settings now includes a JSON depreciation policy with default useful life, residual value, and category/ownership matching rules; Reports and Asset Overview Excel now use the same policy.
