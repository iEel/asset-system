...
> **Latest Update:** ✅ Evidence image optimization guard added: shared `FileDropzone` now compresses large browser-supported photos client-side with 90% JPEG quality, a 2,560px target long edge, and a 1,800px readability floor while preserving originals when optimization is unsafe or not smaller.
