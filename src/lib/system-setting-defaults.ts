...
export const systemSettingDefaults = [
  ...
  { key: "ldap_sync_schedule", value: "0 2 * * *", description: "Cron schedule เวลาไทย (Asia/Bangkok) สำหรับ LDAP sync" },
  ...
  { key: "asset_label_compact_asset_name_enabled", value: "true", description: "ย่อชื่อทรัพย์สินเฉพาะตอนพิมพ์ Label โดยตัดชื่อหมวดหมู่ที่ซ้ำจากชื่อแนะนำ" },
