...
export default async function NewMaintenanceTicketPage({ params, searchParams }: Props) {
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-3xl text-sm text-muted-foreground">{t("createSubtitle")}</p>
        </div>
      ...
      <MaintenanceTicketForm locale={locale} initialAsset={initialAsset} />
    </div>
  )
}
