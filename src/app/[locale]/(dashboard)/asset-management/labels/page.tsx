  ...
  return (
    <AssetLabelBatchTool
      ...
      labels={{
        ...
        addFilteredQueue: t("addFilteredQueue"),
        addFilteredQueueUnavailable: t("addFilteredQueueUnavailable"),
        recentQueueEmpty: t("recentLabelQueueEmpty"),
        all: tCommon("all"),
        queueScopeTitle: t("queueScopeTitle"),
        queueScopeHelp: t("queueScopeHelp"),
        queueScopeCompany: t("queueScopeCompany"),
        queueScopeBranch: t("queueScopeBranch"),
        queueScopeLocation: t("queueScopeLocation"),
        queueScopeAll: t("queueScopeAll"),
