...
> **Latest Update:** ✅ Employee My Assets added: linked employee users can open `/{locale}/my-assets` to see only active assets they currently hold, without broad Asset Register visibility, and owned asset thumbnails are served through a narrow attachment permission fallback.
