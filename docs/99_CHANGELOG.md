...
> **Latest Update:** ✅ Cross-scope asset visibility Phase 1 adds Dashboard KPI/review drilldowns, Asset Register quick filters, Reports summary/preview drilldowns, and Excel export coverage for assets held or located outside the owner/tag scope while leaving custody, transfer, and asset master workflows unchanged. Asset create/edit also keeps Save and Cancel visible in a fixed bottom action bar for long single-asset forms.
