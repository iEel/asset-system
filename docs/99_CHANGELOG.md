...
185. Serial Number barcode scanner fallback with optional browser `BarcodeDetector`, focused scan-band canvas crops before full-frame ZXing decode, no forced serial digital zoom, narrower 16:9 scan-line guidance overlay, updated Thai/English help text, and regression tests for the serial decode path
