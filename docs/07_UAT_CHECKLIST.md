...
- [ ] Recheck the adjusted mobile Asset Register card in a live browser when the local in-app browser is available. Two final-review preview attempts could not attach a tab, so no new visual-pass claim was made; existing 375/390/414 evidence and source geometry tests remain the current coverage.
