...
- [ ] Confirm Serial Number scanner inputs scan manufacturer QR/barcode labels with the 16:9 wide guide, native-resolution ZXing multi-format decoder, and no video cropping; center only the barcode/QR and adjust distance until the lines are sharp.
- [ ] Check-out an asset.
- [ ] Check-in an asset.
- [ ] Transfer an asset.
