...
- [ ] Using keyboard only, open status, close, attachment-delete, and PM state dialogs; verify initial focus, Tab containment, Escape dismissal when not saving, focus restoration, visible focus rings, and 390px mobile layout without body overflow.
